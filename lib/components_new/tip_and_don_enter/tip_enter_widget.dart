...
class EnterTipWidget extends StatefulWidget {
  static const String id = 'EnterTipWidget';
  ...
  @override
  _EnterTipWidgetState createState() => _EnterTipWidgetState();
}

class _EnterTipWidgetState extends State<EnterTipWidget> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${AppTranslations.of(context).text("Tip to make your delivery boy a day")}",
                ...
                InputTextFormField(
                  ...
                  hintText:
                      "${AppTranslations.of(context).text("enter tip amount")}",
                ),
